...
Dijital içeriklere erişim başladıktan sonra cayma/iade hakkı ilgili mevzuat kapsamında sınırlanabilir. Buna rağmen teknik erişim sorunu, mükerrer ödeme, hatalı tahsilat veya yanlış eğitim tanımlaması gibi durumlar ayrıca değerlendirilir.
...
Uygun bulunan iadeler, Payhip ve iyzico güvenli ödeme altyapısı ile bankanızın işlem sürelerine bağlı olarak tamamlanır. Banka veya ödeme sağlayıcı kaynaklı işlem süreleri ERES Akademi kontrolü dışında olabilir.

## İletişim

İptal/iade talepleriniz için [info@eresbiotech.com](mailto:info@eresbiotech.com) adresinden bize ulaşabilirsiniz.
