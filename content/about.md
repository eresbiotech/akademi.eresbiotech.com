...
## NaturaLogic destekli erişim

NaturaLogic, ERES ekosisteminde bilim, veri okuryazarlığı, doğa ve sürdürülebilirlik odağında geliştirilen yeni eğitim ve araştırma markasıdır. ERES Biyoinformatik Akademi’nin yenilenme döneminde, daha fazla öğrenci ve araştırmacının nitelikli biyoinformatik eğitimlerine erişebilmesi için seçili eğitimler NaturaLogic destekli ücretlerle sunulmaktadır.

Bu yaklaşım, eğitim değerinden ödün vermeden daha fazla katılımcının uygulama odaklı biyoinformatik öğrenme süreçlerine ulaşabilmesi için tasarlanmıştır.

## Kimler için?

- Yaşam bilimleri alanında eğitim alan lisans, yüksek lisans ve doktora öğrencileri
- Akademik araştırmalarında biyoinformatik araçları daha bilinçli kullanmak isteyen araştırmacılar
- Laboratuvar, hastane, araştırma merkezi, kamu veya özel sektörde veri odaklı becerilerini güçlendirmek isteyen profesyoneller
- Kurumsal ekipler ve araştırma grupları
